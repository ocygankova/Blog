...
function Privacy() {
  return (
    <Container sx={{ pb: 4, pt: 12 }}>
      <h1>Privacy Policy for Daily Blog</h1>
      ...
      <p>
        ...
        not hesitate to contact us. Our Privacy Policy was created with the help of the{' '}
      ...
      <p>
        Daily Blog follows a standard procedure of using log files. These files log visitors when
      ...
      <p>
        Like any other website, Daily Blog uses &quot;cookies&quot;. These cookies are used to store
      ...
      <p>
        ...
        Beacons that are used in their respective advertisements and links that appear on Daily
        Blog, which are sent directly to users&apos; browser. They automatically receive your IP
      ...
      <p>
        Note that Daily Blog has no access to or control over these cookies that are used by
      ...
      <p>
        Daily Blog&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we
      ...
      <p>
        Daily Blog does not knowingly collect any Personal Identifiable Information from children
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in Daily Blog. This
